        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mr-4">
            <li class="nav-item active">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="#">Tranksaksi <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item active">
            ...
            <div class="row mx-auto">
              <div class="card mr-2 ml-2" style="width: 16rem;">
                ...
                <div class="card-body bg-light">
                  ...
                  <a href="login.php" class="btn btn-primary">Rp.20.000</a>
                </div>
              </div>
              <div class="card mr-2 ml-2" style="width: 16rem;">
                ...
                <div class="card-body bg-light">
                  ...
                  <a href="login.php" class="btn btn-primary">Rp.60.000</a>
                </div>
              </div>
              <div class="card mr-2 ml-2" style="width: 16rem;">
                ...
                <div class="card-body bg-light">
                  ...
                  <a href="login.php" class="btn btn-primary">Rp.50.000</a>
                </div>
              </div>
              <div class="card mr-2 ml-2" style="width: 16rem;">
                ...
                <div class="card-body bg-light">
                  ...
                  <a href="login.php" class="btn btn-primary">Rp.10.000</a>
                </div>
              </div>
            </div>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <a button href="login.php" type="button" class="btn btn-primary">Beli</button></a>
                  </div>
                </div>
              </div>
            </div>
